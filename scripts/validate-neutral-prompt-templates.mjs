...
mustInclude("src/core/prompts.ts", [
  ...
  "background host, pacing controller, fact ledger, and visibility gatekeeper",
  "Control motion, sides, speaker positions, rounds, next speaker, phase summaries, and verdict timing",
  "Public speech is only for setup confirmation",
  "Role assignments, next speaker selection, faction strategy",
...
mustInclude("src/core/roomProfiles.ts", [
  ...
  "background host, pacing controller, fact ledger, visibility gatekeeper",
